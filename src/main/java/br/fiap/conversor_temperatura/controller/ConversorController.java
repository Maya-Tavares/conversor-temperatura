package br.fiap.conversor_temperatura.controller;

import br.fiap.conversor_temperatura.service.ConversorService;
...
public class ConversorController {
    ...
    public String converter(@RequestParam double celsius, Model model){
        double fahrenheit = service.celsiusParaFarenheit(celsius);
